...
function App() {
  ...
  const options = Object.keys(currencyInfo) // option me saari currency key aa gyi
 ...
 return (
		<div
			...
			style={{
				backgroundImage: `url('https://images.pexels.com/photos/12008066/pexels-photo-12008066.jpeg')`,
			}}
		>
